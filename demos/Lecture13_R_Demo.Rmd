...
As discussed in the Lecture 10 demo, we can use local regression / loess smoothing in `geom_smooth()`:
...
## Pairs plot with [`GGally`](https://ggobi.github.io/ggally/index.html) package
