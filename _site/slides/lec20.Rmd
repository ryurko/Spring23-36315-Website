---
title: "36-315 Lecture 20"
subtitle: "Visualizing Trends and Animations"  
author: 
  - "Professor Ron Yurko"
date: '4/10/2023'
output:
...
#### This week we will consider time series data.

Time Series: Measure an outcome for one or more subjects over a period of time.

Main questions that come up in time series:

1. _What happened in the past?_ 

+ Requires summarizing/describing/analyzing the data

2. _What will happen in the future?_

+ Requires prediction/estimation based on past data.

#### Today: We're going to focus on 1 - visualizing time series data in various ways
...
#### Typically display time series trends with lines

+ When visualizing many lines, often useful to consider highlighting a small subset

#### Animations can be used to visualize temporal aspects of data 
...
Review more code in Lecture 20 Demo! 
