...
#### t-SNE and UMAP are approaches for nonlinear dimension reduction

#### We lose the interpretability of PCA

#### Have tuning parameters that impact the results

#### Shiny is the go-to approach for building interactive web apps in `R`

--

__Final project reports due by email on Monday May 1st at 11:59 PM EST! (one per group)__

Review more code in Lecture 24 Demo, Bonus Demo, and example Shiny app files! 
...
- [Shiny tutorials](https://shiny.rstudio.com/tutorial/), [Shiny Gallery](https://shiny.rstudio.com/gallery/)

- __Please complete FCEs!__
