...
#### Start working on your final group projects!

- Homework 8: Time series + __EDA for final group project__ (don't put off until the last minute!)

Last week: Time series, moving averages, autocorrelation, lags, decomposition into trends, seasonality, and noise

--

This week: Text data, starting with:
...
## Reducing the Dimension of Text: Bag of Words

How can we _quantify_ text data such that it can be used in statistical models, analyses, and graphs?

--

#### __Bag of Words__ representation of text is the most common representation
...
Example line: "Yes I remember. Mmm, this is B.S. This is B.S." - Michael Scott

--

Bag of words representation:

- Yes = 1, I = 1, remember = 1, Mmm = 1

- this = 2, is = 2, B.S. = 2

We reduced the dimensions from effectively infinite to 7 dimensions
...
Load `stop_words` from `tidytext` and `filter` to remove them:
...
#### Text is infinite-dimensional, need to represent text with a finite number of dimensions

#### Most common form: bag of words and term frequencies (possibly weighted by TF-IDF)

#### Word clouds are common way to visualize the most frequent words in a set of documents

#### TF-IDF weighting allows you to detect words that are uniquely used in certain documents

- Common to plot the most "important words" of a set of documents, ordered by TF-IDF weights
...
Review more code in Lecture 22 Demo! 
