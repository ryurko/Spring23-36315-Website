...
# For many folks, you should be able to install the ggmap R package just with the typical
# install.packages("ggmap")
# If this cases issues, you can also use the following:
